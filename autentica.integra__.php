...
?>
    ...
    <meta http-equiv="refresh" content="0; URL='autentica.integra.php?fase_acesso=1'"/>
...
if ($_GET[fase_acesso] == 1) {
   ...
   // echo $query;
    ...
    header("location: index2.php"); // SEM ALTERAÇÃO EM RELAÇÃO AO ORIGINAL, MAS TINHA UM DELEGADO QUE NÃO ESTAVA CONSEGUINDO ACESSAR, POR CONTA DO ERRO FANTASMA. DAÍ MUDEI A URL.
